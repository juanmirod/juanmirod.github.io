...
One thing to take into account with Karpathy's video is that he explains how to build a GPT, which is a Decoder and then the attention layer is masked, this does not happends with encoders, and the transformer paper uses both encoder and decoder because it was a paper about language translation. He explains this at the end of the attention part.
